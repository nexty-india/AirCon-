...
//int UART_BUFFER = 25;
//uint8_t  g_rx_buffer[UART_BUFFER] = {0} ;
/* Motor 2 */
...
static void InitUART0(void)
{
	...
	//
	////    /* Use dynamic clock frequency for accuracy */
	  // uint32_t uartClkFreq = CLOCK_GetFreq(kCLOCK_Fro12M);  // Should be 12MHz
	//
