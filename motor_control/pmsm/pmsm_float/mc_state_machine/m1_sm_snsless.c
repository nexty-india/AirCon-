...
static void M1_StateRunSpinSlow(void)
{
    if (g_sM1Drive.eControl == kControlMode_SpeedFOC)
    {
        ...
        {
            u16StartupTime++;
            g_sM1Drive.sSpeed.sSpeedPiParams.fltPGain = M1_SPEED_PI_PROP_GAIN + u16StartupTime*(0.00253232F-M1_SPEED_PI_PROP_GAIN)/MergeDuration;
            ...
            if(u16StartupTime>=MergeDuration)
            {
                ...
                g_sM1Drive.sSpeed.sSpeedRampParams.fltRampUp = 150.0/M1_N_ANGULAR_MAX/M1_SLOW_LOOP_FREQ;
                g_sM1Drive.sSpeed.sSpeedPiParams.fltPGain    = 0.00253232F;
...
//                g_sM1Drive.sFocPMSM.sIqPiParams.fltIGain    = 0.7681;
                ...
                //F0=220Hz, ksi=1.3
                g_sM1Drive.sFocPMSM.sIdPiParams.fltPGain    = 42.14;
                g_sM1Drive.sFocPMSM.sIdPiParams.fltIGain    = 3.699;
                g_sM1Drive.sFocPMSM.sIqPiParams.fltPGain    = 66.94;
                g_sM1Drive.sFocPMSM.sIqPiParams.fltIGain    = 5.809;
