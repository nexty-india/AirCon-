...
/*
    ...
    * DATE: Tue Oct 28 2025, 16:15:18
*/

/*
{
    "compressorParameters": {
        "compressorParametersPP": 4,
        "compressorParametersR": 9.45,
        "compressorParametersLD": 0.02743,
        "compressorParametersLQ": 0.0297,
        "compressorParametersSpeedNom": 2000,
        "compressorParametersFlux": 0.18271576,
        "compressorParametersUnom": 179,
        "compressorParametersImax": 10.12,
        "compressorParametersUdcbMax": 443.3,
        "compressorParametersSpeedMax": 2500,
        "compressorParametersUdcbUnder": 260,
    ...
    "compressorCurrentLoop": {
        ...
        "compressorCurrentLoopKsi": 1.3,
        "compressorCurrentLoopF0": 220,
        "compressorCurrentLoopOutputLimit": 90,
        "compressorCurrentLoopUdcbFilterFreq": 5
    },
    "compressorSpeedLoop": {
        "compressorSpeedLoopPiPropGain": 0.0101293,
        "compressorSpeedLoopPIIntegGain": 0.0000545522,
    ...
    "compressorScalar": {
        ...
        "compressorAlignVoltage": 4,
        "compressorAlignDurationTime": 1,
    ...
    "fanParameters": {
        "fanParametersPP": 5,
        "fanParametersR": 54.3,
        "fanParametersLD": 0.218,
        "fanParametersLQ": 0.254,
        "fanParametersSpeedNom": 900,
        "fanParametersFlux": 0.18,
    ...
    "fanSpeedLoop": {
        ...
        "fanSpeedPIPropGain": 0.0036837,
        "fanSpeedPIIntegGain": 0.00000192878,
        "fanSpeedLoopRampUp": 150,
...
#define M1_R (9.45F)
#define M1_LD (0.02743F)
#define M1_LQ (0.0297F)
#define M1_SPEED_NOM (2000.0F)
#define M1_FLUX (0.182716F)
#define M1_U_NOM (179.0F)
#define M1_I_MAX (10.12F)
#define M1_U_DCB_MAX (443.3F)
#define M1_SPEED_MAX (2500.0F)
...
#define M1_U_DCB_UNDERVOLTAGE (260.0F)
...
#define M1_CURRENT_CLOOP_ATT (1.3F)
#define M1_CURRENT_CLOOP_FREQ (220.0F)
...
/* COMPRESSORSPEEDLOOP*/
#define M1_SPEED_PI_PROP_GAIN (0.0101293F)
#define M1_SPEED_PI_INTEG_GAIN (0.0000545522F)
...
/* COMPRESSOROBSERVER*/
#define M1_HYBRID_FLUX_GAIN (2.0F)
#define M1_FLUX_CURRENT_LIMIT (5.0F)
#define M1_FLUX_TO_ATT (0.707F)
#define M1_FLUX_TO_F0 (140.0F)
#define M1_FLUX_TO_KP_GAIN FRAC16(0.59388)
#define M1_FLUX_TO_KP_SHIFT (1)
#define M1_FLUX_TO_KI_GAIN FRAC16(0.945795)
#define M1_FLUX_TO_KI_SHIFT (-3)
#define M1_FLUX_TO_THETA_GAIN FRAC16(0.853333)
#define M1_FLUX_TO_THETA_SHIFT (-4)
...
#define M1_ALIGN_VOLTAGE (4.0F)
#define M1_ALIGN_DURATION_TIME (1.0F)
...
#define M2_SPEED_PI_PROP_GAIN (0.00368370F)
#define M2_SPEED_PI_INTEG_GAIN (0.00000192878F)
#define M2_SPEED_LOOP_RAMP_UP (150.0F)
