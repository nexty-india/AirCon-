...
#define PFC_VIN_PHASEDETECT_TH                        100.0    /* Input voltage threshold for phase detection [V] */

/*************************************** Voltage&Current Scales ************************************************/
#define PFC_V_DCB_SCALE						443.3	/* MAX measurable DCB voltage [V] */
#define PFC_V_IN_SCALE						443.3	/* MAX measurable input voltage [V] */
#define PFC_I_SCALE						55//	(49.5)  	/* MAX measurable current [A] */
#define PFC_I_HARDWARE_OFFSET                                   16430
...
#define PFC_OVERVOLT_LIMIT               	400.0 	/* Max DC bus voltage [V] */
#define PFC_UNDERVOLT_LIMIT              	300.0 	/* Min DC bus voltage [V] */
#define PFC_IOVER_LIMIT                     20.0 	/* Max input current [A] */
...
#define PFC_U_DCB_REF		            360.0   /* Required DC bus voltage [V] */
#define PFC_U_SOFTSTART_STEP                0.05     /* DC bus reference change step in soft start [V] */
#define PFC_U_DCB_BURSTON                   (PFC_U_DCB_REF-6.0)   /* In light load mode, current control is enabled when DC bus voltage falls below this value */
...
#define PFC_U_P_GAIN						(1.055)		/* Voltage controller proportional gain */
#define PFC_START_U_I_GAIN					(0.035)	/* Voltage controller integral gain */
#define PFC_U_I_GAIN						(0.105)	/* Voltage controller integral gain */
...
#define HIGH_CURRENT         				(14.0)   			/* Upper rms limit of input current reference, [A] */
...
//---------------------------------------------------------------------
#define PFC_I_P_GAIN1						(0.028) 		/* Current controller proportional gain */
#define PFC_I_I_GAIN1						(0.010) 		/* Current controller integral gain */
#define PFC_I_UPPER_LIMIT   				(0.99) 	/* Current controller upper limit */
#define PFC_I_LOWER_LIMIT    				(-0.99)   /* Current controller lower limit */
#define PFC_DCM_DUTY_COEFF   				(4.090)    /* (2*L*PFC_I_SCALE)/(Ts*V_DCB_SCALE) */

/**************************************** Application time base ***********************************************/
#define PFC_PWM_FREQ                        64                  /* PFC switch frequency [kHz] */
...
#define PFC_FASTLOOP_FREQ                   (PFC_PWM_FREQ/2.0/PWM_FREQ_VS_CTR_FREQ*1000.0)  /* PFC fastloop frequency [Hz] */
...
#define PFC_DC_BUS_BURST_UNDER_DELTA              10.0  /* During burst mode, when DC bus voltage is lesser than (PFC_U_DCB_BURSTON-PFC_DC_BUS_BURST_UNDER_DELTA), go to normal sub-state */
